"""
Django settings for PI3SEM project.
...
SECRET_KEY = 'django-insecure-c$k(^@0f@cbl^ca8%y85#+shc82gem@!s)*j7cb$o%@kp2%%kk'
...
WSGI_APPLICATION = 'PI3SEM.wsgi.application'
ASGI_APPLICATION = 'PI3SEM.asgi.application'
